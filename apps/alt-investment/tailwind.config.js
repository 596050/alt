	...
	theme: {
		extend: {
			...
			colors: {
				...
				'primary-5-50': 'var(--primary-5-50)',
				'primary-1-darker-1': 'var(--primary-1-darker-1)',
				'primary-1-lighter-1': 'var(--primary-1-lighter-1)',
				secondary: 'var(--secondary)',
				'secondary-50': 'var(--secondary-50)',
				'primary-off-white': 'var(--primary-off-white)',
				'gradient-primary-off-white': 'var(--gradient-primary-off-white)',
			},
			boxShadow: {
		...
		fontFamily: {
			frutiger: ['Frutiger'],
			'frutiger-bold': ['Frutiger-Bold'],
		},
	},
	plugins: [
		plugin(function ({addVariant}) {
			addVariant('focus-within-child-buttons', '&:focus-within button');
			addVariant('hover-within-child-buttons', '&:hover button');
			addVariant('focus-within-child-any', '&:focus-within *');
			addVariant('hover-within-child-any', '&:hover *');
		}),
